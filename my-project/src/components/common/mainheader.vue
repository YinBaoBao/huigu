    ...
    methods: {
      ...
      Initialize(){
        ...
        .then((res)=>{
          ...
          this.items=[{index:'province',title:'省份管理'},{index:'urban',title:'城市管理'},{index:'district',title:'区县管理'},{index:'headoffice',title:'银行总行管理'},{index:'branch',title:'银行支行管理'}];
          this.organizations=[{index:'agency',title:'代理评估公司管理'},{index:'bank',title:'银行管理'},/*{index:'department',title:'部门管理'}*/];
