  ...
  <div id="department">
   <div class="mainNavadd">
    ...
    <div class="mainSearch">
      <el-select class="mainSearchFloat" v-model="channelIda" placeholder="请选择公司">
  ...
  methods:{
    ...
    mainSearch:function(){    //查询
      this.fullscreenLoading = true;
        setTimeout(() => {
          this.fullscreenLoading = false;
      this.$http.get(this.$store.state.api+'/department/',{params:{pageNum:1,pageSize:this.pageSize,departmentName:this.mainSearchinput,channelId:this.channelIda}},{emulateJSON: true})
      .then((res)=>{
      this.tableData = res.body.dataList;
      })
       }, 1000);
...
#department .mainSearch{
  width: 500px
}
#department .mainNavadd{
  margin-left: 280px;
  margin-top: 20px;
  margin-bottom: 20px;
}
